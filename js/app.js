...
Enemy.prototype.update = function(dt) {
    ...
    if (player.x < this.x + 55 && player.x + 55 > this.x && player.y < this.y + 55 && 65 + player.y > this.y) {
        /*
         * When player collides with bug Game is reset and the chance count is reduced
         */
        player.chances();
        player.reset();
...
Player.prototype.win = function() {
    ...
    chance = chance + 1;
    alert("YAY! you made it \n Continue Playing \n 1 Chance has been added");
    ch.innerHTML = chance;
};

// Reset Function when Player looses the game
...
//Bugs pushed into allEnemies array
